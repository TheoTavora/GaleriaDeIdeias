...
// in appideias/test/mocks/mocks.dart.
...
import 'package:appideias/services/firestore_service.dart' as _i8;
...
class MockFirestoreService extends _i1.Mock implements _i8.FirestoreService {
  ...
  _i4.FirebaseFirestore get db =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeFirebaseFirestore_9(this, Invocation.getter(#db)),
          )
          as _i4.FirebaseFirestore);

  @override
  _i5.Stream<List<Map<String, dynamic>>> getIdeias() =>
      (super.noSuchMethod(
            Invocation.method(#getIdeias, []),
